...
from ..llavaSNNFULL.llava import SNNAutoModelForVision2Seq
# from ..llavaSNNFULL.QwenVL import SNNAutoModelForVision2Seq
    ...
    if model is None and not lazy_load:
        ...
        if model_args.mixture_of_depths == "load":
            ...
            if model_args.train_from_scratch:
                ...
                model = SNNAutoModelForVision2Seq.from_pretrained(**init_kwargs)
